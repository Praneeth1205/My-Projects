...
class AccountSettingsActivity : AppCompatActivity() {
    ...
    private fun updateUserInfoOnly()
    {
        ...
        when {
            full_name_profile_frag.text.toString() == "" -> Toast.makeText(this,"Full Name is Empty",Toast.LENGTH_LONG).show()
            user_name_profile_frag.text.toString() == "" -> Toast.makeText(this,"User Name is Empty",Toast.LENGTH_LONG).show()

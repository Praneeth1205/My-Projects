...
class AddStoryActivity : AppCompatActivity() {
    ...
    private var storagePostStoryRef : StorageReference? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        storagePostStoryRef = FirebaseStorage.getInstance().reference.child("Story Pictures")
    ...
    private fun uploadStory() {
        when {
            imageUri == null -> Toast.makeText(
                ...
                progressDialog.setMessage("Please wait, we are updating your Story...")
                progressDialog.show()

                val fileRef = storagePostStoryRef!!.child(System.currentTimeMillis().toString() + ".jpg")
                ...
                uploadTask.continueWithTask(Continuation <UploadTask.TaskSnapshot, Task<Uri>>{ task ->
                    ...
                    if (task.isSuccessful)
                    {
                        ...
                        val timeEnd = System.currentTimeMillis() + 86400000 //oneday later
                        ...
                        Toast.makeText(this, "Story has been Uploaded Succesfully...", Toast.LENGTH_LONG).show()
